...
export async function handler(event) {
  try {
    ...
    let items = (data.resources || []).map(r => ({
      id: r.public_id,
      thumb: `https://res.cloudinary.com/dvz4druzc/image/upload/f_auto,q_auto,w_480/${r.public_id}.${r.format}`,
      full:  `https://res.cloudinary.com/dvz4druzc/image/upload/f_auto,q_auto,w_1600/${r.public_id}.${r.format}`,
